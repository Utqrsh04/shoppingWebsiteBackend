...
function putOrderdataIntoHtml(order_data) {
  ...
  const tax = order_data.tax;
  const delivery = order_data.delivery;
          ...
          <tr>
            <td class="esd-email-paddings" valign="top">
                                  ...
                                  <tr>
                                    <td class="esdev-mso-td" valign="top">
                                      <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                        <tbody>
                                          <tr>
                                            <td width="415" class="es-m-p0r esd-container-frame" valign="top"
                                              align="center">
                                              <table cellpadding="0" cellspacing="0" width="100%">
                                                <tbody>
                                                  <tr>
                                                    <td align="left" class="esd-block-image" style="font-size: 0px;"><a
                                                        target="_blank" href="https://viewstripo.email">
                                                        <img src="" alt="Logo" style="display: block;" width="120"
                                                          title="Logo"></a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p5t es-p5b">
                                              <p>Your order has been made. Here's some information about your
                                                package .</p>
                                            </td>
                                          </tr>
                                        </tbody>
                    ...
                    <td class="esd-stripe" align="center">
                      <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-text">
                                              ...
                                              <p style="line-height: 150%;">${getTodaysDate()}</p>
                                            </td>
                                          </tr>
                                          <tr>
                          ...
                          ${generateProductCard(order_data.products)}
              ...
              <table cellpadding="0" cellspacing="0" class="es-footer esd-footer-popover" align="center">
                <tbody>
                  <tr>
                    <td class="esd-stripe" align="center" esd-custom-block-id="343277" bgcolor="#ffffff"
                                  ...
                                  <tr>
                                    <td width="560" class="esd-container-frame" align="left">
                                      <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-social es-p10t es-p10b"
                                              style="font-size:0">
                                              <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                <tbody>
                                                  <tr>
                                                    <td align="center" valign="top" class="es-p20r"
                                                      esd-tmp-icon-type="instagram"><a target="_blank"
                                                        href="https://instagram.com"><img title="Instagram"
                                                    ...
                                                    <td align="center" valign="top"><a target="_blank"
                                                        href="https://wa.me/917452943999?text=Hey%20i%20have%20a%20issue%20with%20this%20order%20${
                                                          order_data.order_id
                                                        }%20."><img
                                                          title="Whatsapp"
                                                          src="https://stripo.email/static/assets/img/messenger-icons/logo-black/whatsapp-logo-black.png"
                                                          alt="Whatsapp" width="32"></a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
...
function generateBill(totalItems, subtotal, tax, delivery, totalPrice) {
  const billHTML = `<tr> <td class="esd-structure es-p20r es-p20l esdev-adapt-off" align="left"> <table width="560" cellpadding="0" cellspacing="0" class="esdev-mso-table"> <tbody> <tr> <td class="esdev-mso-td" valign="top"> <table cellpadding="0" cellspacing="0" class="es-left" align="left"> <tbody> <tr> <td width="466" class="esd-container-frame" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tbody> <tr> <td align="right" class="esd-block-text"> <p>Subtotal<br>Tax<br>Shipping<br><b>Total (${totalItems})</b></p> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </td> <td width="20"></td> <td class="esdev-mso-td" valign="top"> <table cellpadding="0" cellspacing="0" class="es-right" align="right"> <tbody> <tr> <td width="74" align="left" class="esd-container-frame"> <table cellpadding="0" cellspacing="0" width="100%"> <tbody> <tr> <td align="right" class="esd-block-text"> <p> ${subtotal}<br>${tax}<br>${delivery}<br><strong>${totalPrice}</strong> </p> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </td> </tr>
`;

  return billHTML;
}

function generateProductCard(products) {
...
function putShippingDataIntoHtml(shippingData) {
  const shippingHtml = ` <tr> <td class="esd-structure es-p20t es-p20r es-p20l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tbody> <tr> <td width="560" class="esd-container-frame" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%"> <tbody> <tr> <td align="left" class="esd-block-text es-m-txt-c es-p20t"> <p style="color: #a0937d;">SHIPPING ADDRESS</p> </td> </tr> <tr> <td align="center" class="esd-block-spacer es-p5t es-p5b" style="font-size:0"> <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0"> <tbody> <tr> <td style="border-bottom: 1px solid #a0937d; background: none; height: 1px; width: 100%; margin: 0px;"> </td> </tr> </tbody> </table> </td> </tr> <tr> <td align="left" class="esd-block-text"> <p> <span>${shippingData.street}</span><br>${shippingData?.apartment}<br>${shippingData.city}<br>${shippingData.state}<br>${shippingData.postal_code}<br>${shippingData?.country} </p> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </td> </tr>`;

  return shippingHtml;
}

module.exports = { putOrderdataIntoHtml };
